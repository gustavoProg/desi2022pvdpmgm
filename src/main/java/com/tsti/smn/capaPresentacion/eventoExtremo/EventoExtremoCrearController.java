    ...
    public String submit(@ModelAttribute("formBean") /*@Valid*/  
    	...
    	if(action.equals("Aceptar"))
    	{
    		...
    		else
    		{
    			...
    			formBean.setAlertasEnviadas(service.enviarCorreos(e));
    			modelo.addAttribute("formBean",formBean);
//    			return "/eventoExtremoAlertasEnviadas/"+e.getIdEventoExtremo();
//    			return "redirect:/eventoExtremoAlertasEnviadas/"+e.getIdEventoExtremo();
